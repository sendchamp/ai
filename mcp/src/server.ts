...
// Default to stdio for mcp-proxy / Glama / IDE clients. Opt into Streamable HTTP
// with --http or MCP_TRANSPORT=http (Railway / mcp.sendchamp.com).
...
function startHttpServer(): void {
	...
	const handleMcpGetDelete = async (
		req: express.Request,
